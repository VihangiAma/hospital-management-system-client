...
const PurchaseOrderPage = () => {
  ...
  const fetchPurchaseOrders = async () => {
    try {
      ...
      if (Array.isArray(res.data)) setPurchaseOrders(res.data);
  ...
  // ✅ Fetch suppliers and medicines correctly
  ...
  // ✏️ Handle change in main order fields
  ...
  return (
    <div className="p-6 bg-[#F5F5F5] min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-[#2C2C2C]">📦 Manage Purchase Orders</h2>
        <button
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center">
          <div className="bg-white p-6 rounded-lg w-[700px] shadow-lg relative">
            ...
            <h3 className="text-xl font-semibold mb-4 text-[#2C2C2C]">➕ Add Purchase Order</h3>
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label className="block mb-1 font-medium text-[#2C2C2C]">Order Code:</label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label className="block mb-1 font-medium text-[#2C2C2C]">Supplier:</label>
                <select
              ...
              <div className="mb-3">
                <label className="block mb-1 font-medium text-[#2C2C2C]">Items:</label>
